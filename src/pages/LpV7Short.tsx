...
export default function LpV7Short() {
  ...
  const openQuiz = useCallback((source: string = "unknown") => {
    ...
    if (typeof window.fbq === "function") {
      window.fbq("track", "ViewContent", { content_name: "LpV7Short Quiz", source });
    }
  }, []);
  ...
  const handleSubmit = useCallback(async () => {
    ...
    trackEvent("lead_form_submit", {
      form_id: "lp-v7-short-quiz", form_name: "LpV7Short Quiz Funnel",
      page_path: window.location.pathname,
    });
    ...
    if (typeof window.fbq === "function") {
      window.fbq("track", "Contact", { content_name: "LpV7Short Quiz Funnel" });
      if (isHot) {
        window.fbq("track", "CompleteRegistration", { content_name: "LpV7Short Hot Lead" });
        window.fbq("track", "InitiateCheckout", { content_name: "LpV7Short Hot Lead" });
      }
    }
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: "#f5f0eb" }}>
      ...
      <button
        type="button"
        onClick={() => {
          trackEvent("cta_click", { cta_label: "Get the Frontend → AI Roadmap", cta_section: "sumo_bar", page_path: window.location.pathname });
          openQuiz("sumo_bar");
        }}
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-10 sm:py-16">
        <div className="max-w-3xl text-center">
          ...
          <button
            type="button"
            onClick={() => {
              trackEvent("cta_click", { cta_label: "Get the Frontend → AI Roadmap", cta_section: "video_thumbnail", page_path: window.location.pathname });
          ...
          <button
            type="button"
            onClick={() => {
              trackEvent("cta_click", { cta_label: "Get the Frontend → AI Roadmap", cta_section: "cta_button", page_path: window.location.pathname });
              openQuiz("cta_button");
            }}
